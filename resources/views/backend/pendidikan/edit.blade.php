                    ...
                    <div class="row">
                        <form action="{{ route('pendidikan.update', $pendidikan->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="nama" name="nama" value="{{ $pendidikan->nama }}" placeholder="Masukkan nama sekolah atau institusi" required>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select class="form-select" id="tingkatan" name="tingkatan" required>
                                    ...
                                    @foreach($tingkatan as $key => $value)
                                        <option value="{{ $key }}" {{ $pendidikan->tingkatan == $key ? 'selected' : '' }}>{{ $value }}</option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" class="form-control" id="tahun_masuk" name="tahun_masuk" value="{{ $pendidikan->tahun_masuk }}" placeholder="Tahun Masuk" required>
                            </div>

                            <div class="form-group mb-3">
                                <label for="tahun_keluar" class="form-label">Tahun Keluar</label>
                                <input type="text" class="form-control" id="tahun_keluar" name="tahun_keluar" value="{{ $pendidikan->tahun_keluar }}" placeholder="Tahun Keluar" required>
                            </div>
